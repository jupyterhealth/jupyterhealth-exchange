...
CH_INVITATION_LINK_EXCLUDE_HOST = os.getenv("CH_INVITATION_LINK_EXCLUDE_HOST", "").lower() in ("true", "1", "yes")
...
_SITE_URL_ROOT = SITE_URL.rstrip("/")
OIDC_CLIENT_AUTHORITY = f"{_SITE_URL_ROOT}{OIDC_CLIENT_AUTHORITY_PATH}"
OIDC_CLIENT_REDIRECT_URI = f"{_SITE_URL_ROOT}{OIDC_CLIENT_REDIRECT_URI_PATH}"
...
PATIENT_AUTHORIZATION_CODE_CHALLENGE = os.getenv("PATIENT_AUTHORIZATION_CODE_CHALLENGE", "C-rdBzEtxD82FMuHF0_76l6NNu_AIqnVJDL1Ba5j0gs")
PATIENT_AUTHORIZATION_CODE_VERIFIER = os.getenv("PATIENT_AUTHORIZATION_CODE_VERIFIER", "EIlWNRU1_7yyUdw27ryzBvgcoU8ZJ6bgg_F-wkNbbDQ")
