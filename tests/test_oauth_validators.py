...
class JHEOAuth2ValidatorTests(TestCase):
    ...
    def setUp(self):
        ...
        self.study1 = Study.objects.create(
            ...
            description="Longitudinal COVID study",
        ...
        self.study3 = Study.objects.create(
            name="Clinical Trial 123",
            description="Drug efficacy trial",
        ...
        PractitionerOrganization.objects.create(
            practitioner=self.practitioner,
            organization=self.org2,
            role=PractitionerOrganization.ROLE_MEMBER
        )
